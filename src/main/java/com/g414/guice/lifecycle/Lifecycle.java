...
/**
 * The Lifecycle is a singleton instance (as hopefully enforced by the DI
 * container) through which application lifecycle is controlled. This Lifecycle
 * instance is used by a controller object in the app that invokes Lifecycle
 * methods to inform components of application state changes.
 */
